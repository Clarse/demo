package com.eohi.haixin.ui.work.purchasein.retreat
...
import com.eohi.haixin.databinding.FragmentPurchaseCodeBinding
 ...
 */
class PurchaseByCodeFragment :
    BaseFragment<PurchaseByCodeViewModel, FragmentPurchaseCodeBinding>() {
