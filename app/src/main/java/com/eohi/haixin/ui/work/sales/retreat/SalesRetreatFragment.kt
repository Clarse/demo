...
import com.eohi.haixin.databinding.FragmentSalesRetreatBinding
...
//                v.etFsl.setText(it[0].fzsl.toString())
    ...
    private fun showListPopulWindow(
        ...
        listPopupWindow.setOnItemClickListener { adapterView, view, i, l ->
            ...
            mEditText.text =
                Editable.Factory.getInstance().newEditable(khhlist[i]) //把选择的选项内容展示在EditText上
