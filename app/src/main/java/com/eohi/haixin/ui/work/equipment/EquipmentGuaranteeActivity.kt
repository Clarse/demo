...
import com.eohi.haixin.api.HttpUtil
...
import com.eohi.haixin.databinding.ActivityEquipmentGuaranteeBinding
...
import com.eohi.haixin.ui.work.equipment.model.Fault2
import com.eohi.haixin.ui.work.equipment.model.FaultType
import com.eohi.haixin.ui.work.equipment.model.PersonInfo
import com.eohi.haixin.ui.work.model.FileUploadResult
import com.eohi.haixin.ui.work.quality.incoming.IncomingCheckActivity
import com.eohi.haixin.utils.*
...
class EquipmentGuaranteeActivity :
    ...
    override fun onBarcodeEvent(result: String) {
        v.etLzkkh.setText(result.trim { it <= ' ' })
        setEquipment(result.trim { it <= ' ' })
        setTaskFaultType(result.trim { it <= ' ' })
    }
        ...
        RetrofitUtil.builder.baseUrl(apiurl)
            ...
            .setFault(lzkPostModel).enqueue(object : MyCallBack<Any>() {
                override fun failure(apiErrorModel: ApiErrorModel?) {
                    Toast.makeText(mContext, apiErrorModel?.errorMsg, Toast.LENGTH_SHORT).show()
                }
        ...
        if (requestCode == REQUEST_CODE && data != null) {
            ...
            images?.forEach {
                ...
                val body = MultipartBody.Builder().setType(MultipartBody.FORM)
                    ...
                    .addFormDataPart("conmap", "shebeiweixiu")
