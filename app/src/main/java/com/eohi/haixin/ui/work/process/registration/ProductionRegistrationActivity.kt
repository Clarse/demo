package com.eohi.haixin.ui.work.process.registration
...
import com.eohi.haixin.databinding.ActivityProductionRegistrationBinding
import com.eohi.haixin.ui.work.adapter.AddConsumablesAdapter
import com.eohi.haixin.ui.work.model.ClModel
import com.eohi.haixin.ui.work.model.MaterialModel
import com.eohi.haixin.ui.work.model.ProductionSubList
import com.eohi.haixin.ui.work.model.ProductionSubmitModel
import com.eohi.haixin.ui.work.process.viewmodel.ProductionRegistrationViewModel
...
import com.eohi.haixin.view.DialogAddConsumables
import com.eohi.haixin.view.DialogEqu
import com.eohi.haixin.view.DialogSelectList
...
class ProductionRegistrationActivity :
    ...
    override fun initClick() {
        ...
        v.btnSubmit.clicks {
            ...
            val model = ProductionSubmitModel()
            val list = ArrayList<ProductionSubmitModel>()
            ...
            model.bhgsl = v.etBhgsl.text.toString().toInt()
