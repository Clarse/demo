...
import kotlinx.android.synthetic.main.dialog_goods_line.*
...
class DialogGoodsToline(context: Context, themeResId: Int) : Dialog(context, themeResId) {
    ...
    constructor(context: Context, a: Activity?, list: ArrayList<ProductionlineModel>?) : this(
        context,
        R.style.MyDialog
    ) {
        activity = a
    ...
    private fun showListPopulWindow(
        mEditText: TextView,
        list: Array<String>,
        linelist: ArrayList<ProductionlineModel>?
    ) {
        ...
        listPopupWindow.setOnItemClickListener { adapterView, view, i, l ->
            //设置项点击监听
            mEditText.text = linelist!![i].SCXBH //把选择的选项内容展示在EditText上
