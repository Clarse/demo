...
import com.eohi.haixin.databinding.ItemProductionTeamBinding
 ...
 */
class ProductionTeamAdapter(mContext: Activity, listDatas: ArrayList<MyProductionTeamModel>) :
    BaseAdapter<ItemProductionTeamBinding, MyProductionTeamModel>(mContext, listDatas) {
