...
import com.eohi.haixin.databinding.ActivityEquipmentFaultConfirmBinding
...
import com.eohi.haixin.ui.work.equipment.model.FaultPost
        ...
        if (requestCode == EquipmentGuaranteeActivity.REQUEST_CODE && data != null) {
            ...
            images?.forEach {
                ...
                val body = MultipartBody.Builder().setType(MultipartBody.FORM)
                    ...
                    .addFormDataPart("conmap", "guzhangqueren")
