package com.eohi.haixin.ui.work.quality.delivery
...
import com.eohi.haixin.databinding.ActivityDeliveryCheckBinding
        ...
        v.btnGdh clicks {
            gdDialog = ListDialog(this, "选择工单", filterGdhList, object : ListDialog.MyListener {
                override fun refreshActivity(position: Int) {
                    ...
                    vm.getDeliveryDetailGDH(companyNo, filterGdhList[position])
                }
            })
        ...
        if (requestCode == IncomingCheckActivity.REQUEST_CODE && data != null) {
            ...
            images?.forEach {
                ...
                val body = MultipartBody.Builder().setType(MultipartBody.FORM)
                    ...
                    .addFormDataPart("conmap", "fahuojianyan")
