...
import com.eohi.haixin.databinding.ActivityProductionTeamEditBinding
import com.eohi.haixin.event.EventCode
import com.eohi.haixin.event.EventMessage
import com.eohi.haixin.ui.work.my.adapter.ProductionAddPersonAdapter
import com.eohi.haixin.ui.work.my.model.AddxzSubmitModel
import com.eohi.haixin.ui.work.my.model.PersonData
import com.eohi.haixin.ui.work.my.model.ProductionPersonModel
import com.eohi.haixin.ui.work.my.model.UpdatepProcuctModel
    ...
    override fun initVM() {
        ...
        vm.groupMembers.observe(this, Observer {
            if (it.isNotEmpty()) {
                list.clear()
                it.forEach {
                    var model = ProductionPersonModel(
                        "",
                        "",
                        "",
                        "",
