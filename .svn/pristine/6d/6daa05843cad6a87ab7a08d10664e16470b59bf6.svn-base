...
import com.eohi.haixin.databinding.ActivityLoginBinding
...
import com.eohi.haixin.utils.dp2Px
import com.eohi.haixin.view.DialogSettingHttp
...
class LoginActivity : BaseActivity<LoginViewModel, ActivityLoginBinding>() {
    ...
    override fun initVM() {
        vm.companylist.observe(this, Observer {
            if (it.isNotEmpty()) {
                companyList = it
        ...
        vm.loginresut.observe(this, Observer {
            if (it.code == 1000) {
    ...
    private fun showCompanyList() {
        ...
        val items = companyliststr!!.toTypedArray()
