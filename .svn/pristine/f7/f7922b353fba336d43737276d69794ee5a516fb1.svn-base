...
import com.eohi.haixin.databinding.ActivityEquipmentMaintenanceScanListBinding
import com.eohi.haixin.event.EventCode
import com.eohi.haixin.event.EventMessage
import com.eohi.haixin.ui.work.adapter.EquipmentMaintenanceScanListAdapter
import com.eohi.haixin.ui.work.equipment.model.TaskSBLBss
...
class EquipmentMaintenanceScanListActivity :
    ...
    private fun setTaskSBLBss(iss: Boolean, text: String?) {
        if (iss) {
    ...
    private fun myCall(): MyCallBack<FatherList<TaskSBLBss>> {
